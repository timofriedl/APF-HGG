...
inline transform::TMatrix transform0_1(double c0, double s0) {
    transform::TMatrix t;
    t << c0, -s0, 0, 0,
            s0, c0, 0, 0,
            0, 0, 1, 0.333,
...
inline transform::TMatrix transform1_2(double c1, double s1) {
    transform::TMatrix t;
    t << c1, -s1, 0, 0,
            0, 0, 1, 0,
            -s1, -c1, 0, 0,
...
inline transform::TMatrix transform2_3(double c2, double s2) {
    transform::TMatrix t;
    t << c2, -s2, 0, 0,
            0, 0, -1, -0.316,
            s2, c2, 0, 0,
...
inline transform::TMatrix transform3_4(double c3, double s3) {
    transform::TMatrix t;
    t << c3, -s3, 0, 0.0825,
            0, 0, -1, 0,
            s3, c3, 0, 0,
...
inline transform::TMatrix transform4_5(double c4, double s4) {
    transform::TMatrix t;
    t << c4, -s4, 0, -0.0825,
            0, 0, 1, 0.384,
            -s4, -c4, 0, 0,
...
inline transform::TMatrix transform5_6(double c5, double s5) {
    transform::TMatrix t;
    t << c5, -s5, 0, 0,
            0, 0, -1, 0,
            s5, c5, 0, 0,
...
inline transform::TMatrix transform6_7(double c6, double s6) {
    transform::TMatrix t;
    t << c6, -s6, 0, 0.088,
            0, 0, -1, 0,
            s6, c6, 0, 0,
...
inline transform::TMatrix transform_flange() {
