...
Robotics_envs_id = [
    ...
    'FrankaDirectFetchPickDynObstaclesEnv-v1',
    'FrankaDirectFetchPickDynLiftedObstaclesEnv-v1',
    'FrankaDirectFetchPickDynDoorObstaclesEnv-v1'
]
...
def clip_return_range(args):
    ...
    return {
        ...
        'FrankaDirectFetchPickDynObstaclesEnv-v1': (gamma_sum_min, gamma_sum_max),
        'FrankaDirectFetchPickDynLiftedObstaclesEnv-v1': (gamma_sum_min, gamma_sum_max),
        'FrankaDirectFetchPickDynDoorObstaclesEnv-v1': (gamma_sum_min, gamma_sum_max)
    }[args.env]
