...
MODEL_XML_PATH = os.path.join(os.getcwd(), 'envs', 'assets', 'fetch', 'franka_direct_pick_3d_target_obstacle.xml')
...
class FrankaDirectFetchPick3DTargetObstacle(robot_env.RobotEnv, gym.utils.EzPickle):
    def __init__(self, reward_type='sparse', n_substeps=1):
        ...
        apf_utils.setup_obstacle_capsules(self, ('obstacle1',))  # First dynamic, then static
    ...
    def step(self, action):
        ...
        return super(FrankaDirectFetchPick3DTargetObstacle, self).step(action)
    ...
    def render(self, mode='human', width=1080, height=1080):
        return super(FrankaDirectFetchPick3DTargetObstacle, self).render(mode, width, height)
