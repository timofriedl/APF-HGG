...
MODEL_XML_PATH = os.path.join(os.getcwd(), 'envs', 'assets', 'fetch', 'franka_direct_pick_dyn_lifted_obstacles.xml')
...
class FrankaDirectFetchPickDynLiftedObstaclesEnv(robot_env.RobotEnv, gym.utils.EzPickle):
    ...
    def render(self, mode='human', width=1080, height=1080):
        return super(FrankaDirectFetchPickDynLiftedObstaclesEnv, self).render(mode, width, height)
