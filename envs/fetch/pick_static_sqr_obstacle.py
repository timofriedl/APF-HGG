...
MODEL_XML_PATH = os.path.join(os.getcwd(), 'envs', 'assets', 'fetch', 'pick_static_sqr_obstacle.xml')
...
class FetchPickStaticSqrObstacleEnv(robot_env.RobotEnv, gym.utils.EzPickle):
    def __init__(self, reward_type='sparse', n_substeps=20):
        ...
        super(FetchPickStaticSqrObstacleEnv, self).__init__(
    ...
    def step(self, action):
        ...
        return super(FetchPickStaticSqrObstacleEnv, self).step(action)
    ...
    def _get_obs(self):
        ...
        grip_velp = self.sim.data.get_site_xvelp('robot0:grip')
    ...
    def render(self, mode='human', width=1080, height=1080):
        return super(FetchPickStaticSqrObstacleEnv, self).render(mode, width, height)
