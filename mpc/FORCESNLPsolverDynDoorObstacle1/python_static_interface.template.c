 ...
 *  - FORCESNLPsolverDynDoorObstacle1
 *  - "include/FORCESNLPsolverDynDoorObstacle1.h"
 *  - FORCESNLPsolverDynDoorObstacle1_adtool2forces
 *  - FORCESNLPsolverDynDoorObstacle1_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(FORCESNLPsolverDynDoorObstacle1, _float)
#define SOLVER_FUN_NAME CONCATENATE(FORCESNLPsolverDynDoorObstacle1, _solve)

#include "include/FORCESNLPsolverDynDoorObstacle1.h"

/* Header of external evaluation function */
solver_int32_default FORCESNLPsolverDynDoorObstacle1_adtool2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FORCESNLPsolverDynDoorObstacle1_interface(void *params, void *outputs, void *info, void *mem, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, mem, fp, &FORCESNLPsolverDynDoorObstacle1_adtool2forces);
}
