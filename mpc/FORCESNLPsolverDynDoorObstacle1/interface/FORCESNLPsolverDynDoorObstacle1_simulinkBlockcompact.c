...
#define S_FUNCTION_NAME FORCESNLPsolverDynDoorObstacle1_simulinkBlockcompact
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 288, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call solver */
    solver_exitflag = FORCESNLPsolverDynDoorObstacle1_solve(&params, &output, &info, mem, fp , pt2function_FORCESNLPsolverDynDoorObstacle1);
