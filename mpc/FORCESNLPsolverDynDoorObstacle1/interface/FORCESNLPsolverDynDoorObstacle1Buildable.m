...
% 
classdef FORCESNLPsolverDynDoorObstacle1Buildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, cfg)
            ...
            if(~strcmp(foldername, 'interface') || ~strcmp(solvername, 'FORCESNLPsolverDynDoorObstacle1'))
                solverpath = fullfile(buildablepath, 'FORCESNLPsolverDynDoorObstacle1');
            end
            solverInfo = struct();
            solverInfo.solvername = 'FORCESNLPsolverDynDoorObstacle1';
        ...
        function [output,exitflag,info] = forcesCallWithParams(params)
            [output,exitflag,info] = FORCESNLPsolverDynDoorObstacle1Buildable.forcesCall(params.xinit, params.x0, params.all_parameters);
        end

        function [output,exitflag,info] = forcesCall(xinit, x0, all_parameters)
            solvername = 'FORCESNLPsolverDynDoorObstacle1';
            ...
            [output_c, exitflag_c, info_c] = FORCESNLPsolverDynDoorObstacle1Buildable.forcesInitOutputsC(); %#ok<ASGLU>
            ...
            [output, exitflag, info] = FORCESNLPsolverDynDoorObstacle1Buildable.forcesInitOutputsMatlab();
