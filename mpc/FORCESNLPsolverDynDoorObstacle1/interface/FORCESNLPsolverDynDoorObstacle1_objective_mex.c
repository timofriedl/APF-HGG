...
typedef FORCESNLPsolverDynDoorObstacle1_float solver_float;
...
void copyCArrayToM_FORCESNLPsolverDynDoorObstacle1(FORCESNLPsolverDynDoorObstacle1_float *src, double *dest, solver_int32_default dim) 
{
...
void copyCValueToM_FORCESNLPsolverDynDoorObstacle1(FORCESNLPsolverDynDoorObstacle1_float* src, double* dest)
{
    *dest = (double)*src;
}

void copyMArrayToC_FORCESNLPsolverDynDoorObstacle1(double *src, FORCESNLPsolverDynDoorObstacle1_float *dest, solver_int32_default dim) 
{
    solver_int32_default i;
    for( i = 0; i < dim; i++ ) 
    {
...
void copyMValueToC_FORCESNLPsolverDynDoorObstacle1(double * src, FORCESNLPsolverDynDoorObstacle1_float * dest)
{
	*dest = (FORCESNLPsolverDynDoorObstacle1_float) *src;
}
             ...
             solver_int* dimp, solver_int* diml, solver_int* dimu, solver_int* dimhl, solver_int* dimhu)
{
    ...
    const solver_int dimpArr[NSTAGES] = {36, 36, 36, 36, 36, 36, 36, 36};
...
void mexFunction( solver_int nlhs, mxArray *plhs[], solver_int nrhs, const mxArray *prhs[] )  
{
    ...
    arr = prhs[0];
    copyMArrayToC_FORCESNLPsolverDynDoorObstacle1(mxGetPr(arr), z, nvar);
    if (nrhs > 1)
	{
        arr = prhs[1];
        if ( !mxIsEmpty(arr) )
        {
            copyMArrayToC_FORCESNLPsolverDynDoorObstacle1(mxGetPr(arr), p, dimp);
        }
	}   
	...
	copyCArrayToM_FORCESNLPsolverDynDoorObstacle1(obj, mxGetPr(obj_mex), 1);
	copyCArrayToM_FORCESNLPsolverDynDoorObstacle1(jacobj, mxGetPr(gradobj_mex), nvar);
	plhs[0] = obj_mex;
	plhs[1] = gradobj_mex;
