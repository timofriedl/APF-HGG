...
% 
classdef FORCESNLPsolverDynLiftedObstacle1Buildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, cfg)
            ...
            if(~strcmp(foldername, 'interface') || ~strcmp(solvername, 'FORCESNLPsolverDynLiftedObstacle1'))
                solverpath = fullfile(buildablepath, 'FORCESNLPsolverDynLiftedObstacle1');
            end
            solverInfo = struct();
            solverInfo.solvername = 'FORCESNLPsolverDynLiftedObstacle1';
        ...
        function [output,exitflag,info] = forcesCallWithParams(params)
            [output,exitflag,info] = FORCESNLPsolverDynLiftedObstacle1Buildable.forcesCall(params.xinit, params.x0, params.all_parameters);
        end

        function [output,exitflag,info] = forcesCall(xinit, x0, all_parameters)
            solvername = 'FORCESNLPsolverDynLiftedObstacle1';
            ...
            [output_c, exitflag_c, info_c] = FORCESNLPsolverDynLiftedObstacle1Buildable.forcesInitOutputsC(); %#ok<ASGLU>
            ...
            [output, exitflag, info] = FORCESNLPsolverDynLiftedObstacle1Buildable.forcesInitOutputsMatlab();
