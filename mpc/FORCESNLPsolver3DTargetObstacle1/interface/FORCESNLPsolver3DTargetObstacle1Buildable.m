...
% 
classdef FORCESNLPsolver3DTargetObstacle1Buildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, cfg)
            ...
            if(~strcmp(foldername, 'interface') || ~strcmp(solvername, 'FORCESNLPsolver3DTargetObstacle1'))
                solverpath = fullfile(buildablepath, 'FORCESNLPsolver3DTargetObstacle1');
            end
            solverInfo = struct();
            solverInfo.solvername = 'FORCESNLPsolver3DTargetObstacle1';
        ...
        function [output,exitflag,info] = forcesCallWithParams(params)
            [output,exitflag,info] = FORCESNLPsolver3DTargetObstacle1Buildable.forcesCall(params.xinit, params.x0, params.all_parameters);
        end

        function [output,exitflag,info] = forcesCall(xinit, x0, all_parameters)
            solvername = 'FORCESNLPsolver3DTargetObstacle1';
            ...
            [output_c, exitflag_c, info_c] = FORCESNLPsolver3DTargetObstacle1Buildable.forcesInitOutputsC(); %#ok<ASGLU>
            ...
            [output, exitflag, info] = FORCESNLPsolver3DTargetObstacle1Buildable.forcesInitOutputsMatlab();
