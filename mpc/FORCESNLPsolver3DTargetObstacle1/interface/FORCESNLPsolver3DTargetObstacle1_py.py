...
a Python wrapper for a fast solver generated by FORCESPRO v6.2.0
   ...
   OUTPUT = FORCESNLPsolver3DTargetObstacle1_py.FORCESNLPsolver3DTargetObstacle1_solve(PARAMS) solves a multistage problem
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['all_parameters'] - matrix of size [128x1]
   ...
   [OUTPUT, EXITFLAG] = FORCESNLPsolver3DTargetObstacle1_py.FORCESNLPsolver3DTargetObstacle1_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = FORCESNLPsolver3DTargetObstacle1_py.FORCESNLPsolver3DTargetObstacle1_solve(PARAMS) returns 
...
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver3DTargetObstacle1/lib/FORCESNLPsolver3DTargetObstacle1_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver3DTargetObstacle1_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver3DTargetObstacle1/lib/libFORCESNLPsolver3DTargetObstacle1_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver3DTargetObstacle1_solve')

internal_mem = getattr(_lib,'FORCESNLPsolver3DTargetObstacle1_internal_mem')

class FORCESNLPsolver3DTargetObstacle1_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
    _fields_ = [('xinit', ctypes.c_double * 6),
('x0', ctypes.c_double * 80),
('all_parameters', ctypes.c_double * 128),
]

FORCESNLPsolver3DTargetObstacle1_params = {'xinit' : np.array([]),
'x0' : np.array([]),
...
FORCESNLPsolver3DTargetObstacle1_params_types = {'xinit' : np.float64,
'x0' : np.float64,
'all_parameters' : np.float64,
}

class FORCESNLPsolver3DTargetObstacle1_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver3DTargetObstacle1_outputs = {'x1' : np.array([]),
'x2' : np.array([]),
'x3' : np.array([]),
'x4' : np.array([]),
'x5' : np.array([]),
...
class FORCESNLPsolver3DTargetObstacle1_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
class FORCESNLPsolver3DTargetObstacle1_mem(ctypes.Structure):
    pass
...
csolver.argtypes = ( ctypes.POINTER(FORCESNLPsolver3DTargetObstacle1_params_ctypes), ctypes.POINTER(FORCESNLPsolver3DTargetObstacle1_outputs_ctypes), ctypes.POINTER(FORCESNLPsolver3DTargetObstacle1_info), ctypes.POINTER(FORCESNLPsolver3DTargetObstacle1_mem), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

internal_mem.argtypes = [ctypes.c_uint]
internal_mem.restype = ctypes.POINTER(FORCESNLPsolver3DTargetObstacle1_mem)

def FORCESNLPsolver3DTargetObstacle1_solve(params_arg):
    '''
a Python wrapper for a fast solver generated by FORCESPRO v6.2.0
 ...
 See also COPYING
    ...
    # convert parameters
    params_py = FORCESNLPsolver3DTargetObstacle1_params_ctypes()
    for par in params_arg:
        ...
        try:
            ...
            if isinstance(getattr(params_py, par), ctypes.Array):
                params_arg[par] = np.require(params_arg[par], dtype=FORCESNLPsolver3DTargetObstacle1_params_types[par], requirements='F')
    ...
    outputs_py = FORCESNLPsolver3DTargetObstacle1_outputs_ctypes()
    info_py = FORCESNLPsolver3DTargetObstacle1_info()
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FORCESNLPsolver3DTargetObstacle1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), PyFile_AsFile(fp) , _lib.FORCESNLPsolver3DTargetObstacle1_adtool2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FORCESNLPsolver3DTargetObstacle1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), None , _lib.FORCESNLPsolver3DTargetObstacle1_adtool2forces)
            else:
                exitflag = _lib.FORCESNLPsolver3DTargetObstacle1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), fp , _lib.FORCESNLPsolver3DTargetObstacle1_adtool2forces)
            libc.fclose(fp)
    ...
    # convert outputs
    for out in FORCESNLPsolver3DTargetObstacle1_outputs:
        FORCESNLPsolver3DTargetObstacle1_outputs[out] = npct.as_array(getattr(outputs_py,out))

    return FORCESNLPsolver3DTargetObstacle1_outputs,int(exitflag),info_py

solve = FORCESNLPsolver3DTargetObstacle1_solve
