/*
FORCESNLPsolver3DTargetObstacle1 : A fast customized optimization solver.
...
#include "../include/FORCESNLPsolver3DTargetObstacle1_memory.h"
...
void copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float(FORCESNLPsolver3DTargetObstacle1_float *src, double *dest, solver_int32_default dim) 
{
    solver_int32_default i;
    for( i = 0; i < dim; i++ ) 
    {
...
void copyMArrayToC_FORCESNLPsolver3DTargetObstacle1_float(double *src, FORCESNLPsolver3DTargetObstacle1_float *dest, solver_int32_default dim) 
{
    solver_int32_default i;
    for( i = 0; i < dim; i++ ) 
    {
        *dest++ = (FORCESNLPsolver3DTargetObstacle1_float) (*src++) ;
    }
}

void copyMValueToC_FORCESNLPsolver3DTargetObstacle1_float(double * src, FORCESNLPsolver3DTargetObstacle1_float * dest)
{
	*dest = (FORCESNLPsolver3DTargetObstacle1_float) *src;
}
...
extern solver_int32_default (FORCESNLPsolver3DTargetObstacle1_float *x, FORCESNLPsolver3DTargetObstacle1_float *y, FORCESNLPsolver3DTargetObstacle1_float *l, FORCESNLPsolver3DTargetObstacle1_float *p, FORCESNLPsolver3DTargetObstacle1_float *f, FORCESNLPsolver3DTargetObstacle1_float *nabla_f, FORCESNLPsolver3DTargetObstacle1_float *c, FORCESNLPsolver3DTargetObstacle1_float *nabla_c, FORCESNLPsolver3DTargetObstacle1_float *h, FORCESNLPsolver3DTargetObstacle1_float *nabla_h, FORCESNLPsolver3DTargetObstacle1_float *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
FORCESNLPsolver3DTargetObstacle1_extfunc pt2function_FORCESNLPsolver3DTargetObstacle1 = &;


/* Some memory for mex-function */
static FORCESNLPsolver3DTargetObstacle1_params params;
static FORCESNLPsolver3DTargetObstacle1_output output;
static FORCESNLPsolver3DTargetObstacle1_info info;
static FORCESNLPsolver3DTargetObstacle1_mem * mem;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1)
	{
		mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help FORCESNLPsolver3DTargetObstacle1_mex' for details.");
	}    
	if (nlhs > 3) 
	{
    ...
    if (mem == NULL)
    {
        mem = FORCESNLPsolver3DTargetObstacle1_internal_mem(0);
    }
    ...
    if( mxGetM(par) != 128 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.all_parameters must be of size [128 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.all_parameters,128);

	}


	#if SET_PRINTLEVEL_FORCESNLPsolver3DTargetObstacle1 > 0
	...
	exitflag = FORCESNLPsolver3DTargetObstacle1_solve(&params, &output, &info, mem, fp, pt2function_FORCESNLPsolver3DTargetObstacle1);
	...
	*mxGetPr(plhs[1]) = (double)exitflag;
	...
	plhs[2] = mxCreateStructMatrix(1, 1, 20, infofields);
		...
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.res_eq)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "res_eq", outvar);


		/* scalar: inf-norm of inequality constraint residuals */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.res_ineq)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "res_ineq", outvar);


		/* scalar: norm of stationarity condition */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.rsnorm)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "rsnorm", outvar);


		/* scalar: max of all complementarity violations */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.rcompnorm)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "rcompnorm", outvar);


		/* scalar: primal objective */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.pobj)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "pobj", outvar);


		/* scalar: dual objective */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.dobj)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "dobj", outvar);


		/* scalar: duality gap := pobj - dobj */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.dgap)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "dgap", outvar);


		/* scalar: relative duality gap := |dgap / pobj | */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.rdgap)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "rdgap", outvar);


		/* scalar: duality measure */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.mu)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "mu", outvar);


		/* scalar: duality measure (after affine step) */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.mu_aff)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "mu_aff", outvar);


		/* scalar: centering parameter */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.sigma)), mxGetPr(outvar), 1);
		...
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.step_aff)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "step_aff", outvar);


		/* scalar: step size (combined direction) */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.step_cc)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "step_cc", outvar);


		/* scalar: total solve time */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.solvetime)), mxGetPr(outvar), 1);
		mxSetField(plhs[2], 0, "solvetime", outvar);


		/* scalar: time spent in function evaluations */
		outvar = mxCreateDoubleMatrix(1, 1, mxREAL);
		copyCArrayToM_FORCESNLPsolver3DTargetObstacle1_float((&(info.fevalstime)), mxGetPr(outvar), 1);
