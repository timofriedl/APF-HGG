...
typedef FORCESNLPsolver3DTargetObstacle1_float solver_float;
...
void copyCArrayToM_FORCESNLPsolver3DTargetObstacle1(FORCESNLPsolver3DTargetObstacle1_float *src, double *dest, solver_int32_default dim) 
{
...
void copyCValueToM_FORCESNLPsolver3DTargetObstacle1(FORCESNLPsolver3DTargetObstacle1_float* src, double* dest)
{
    *dest = (double)*src;
}

void copyMArrayToC_FORCESNLPsolver3DTargetObstacle1(double *src, FORCESNLPsolver3DTargetObstacle1_float *dest, solver_int32_default dim) 
{
    solver_int32_default i;
    for( i = 0; i < dim; i++ ) 
    {
...
void copyMValueToC_FORCESNLPsolver3DTargetObstacle1(double * src, FORCESNLPsolver3DTargetObstacle1_float * dest)
{
	*dest = (FORCESNLPsolver3DTargetObstacle1_float) *src;
}
             ...
             solver_int* dimp, solver_int* diml, solver_int* dimu, solver_int* dimhl, solver_int* dimhu)
{
    ...
    const solver_int dimhArr[NSTAGES] = {1, 1, 1, 1, 1, 1, 1, 1};
    const solver_int dimpArr[NSTAGES] = {16, 16, 16, 16, 16, 16, 16, 16};
    const solver_int dimlArr[NSTAGES] = {10, 10, 10, 10, 10, 10, 10, 10};
    const solver_int dimuArr[NSTAGES] = {9, 9, 9, 9, 9, 9, 9, 9};
    const solver_int dimhlArr[NSTAGES] = {1, 1, 1, 1, 1, 1, 1, 1};
...
void mexFunction( solver_int nlhs, mxArray *plhs[], solver_int nrhs, const mxArray *prhs[] )  
{
    ...
    arr = prhs[0];
    copyMArrayToC_FORCESNLPsolver3DTargetObstacle1(mxGetPr(arr), z, nvar);
    if (nrhs > 1)
	{
        arr = prhs[1];
        if ( !mxIsEmpty(arr) )
        {
            copyMArrayToC_FORCESNLPsolver3DTargetObstacle1(mxGetPr(arr), p, dimp);
        }
	}   
	...
	copyCArrayToM_FORCESNLPsolver3DTargetObstacle1(obj, mxGetPr(obj_mex), 1);
	copyCArrayToM_FORCESNLPsolver3DTargetObstacle1(jacobj, mxGetPr(gradobj_mex), nvar);
	plhs[0] = obj_mex;
	plhs[1] = gradobj_mex;
