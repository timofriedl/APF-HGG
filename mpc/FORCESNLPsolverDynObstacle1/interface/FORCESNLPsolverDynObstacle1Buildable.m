...
% 
classdef FORCESNLPsolverDynObstacle1Buildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, cfg)
            ...
            if(~strcmp(foldername, 'interface') || ~strcmp(solvername, 'FORCESNLPsolverDynObstacle1'))
                solverpath = fullfile(buildablepath, 'FORCESNLPsolverDynObstacle1');
            end
            solverInfo = struct();
            solverInfo.solvername = 'FORCESNLPsolverDynObstacle1';
        ...
        function [output,exitflag,info] = forcesCallWithParams(params)
            [output,exitflag,info] = FORCESNLPsolverDynObstacle1Buildable.forcesCall(params.xinit, params.x0, params.all_parameters);
        end

        function [output,exitflag,info] = forcesCall(xinit, x0, all_parameters)
            solvername = 'FORCESNLPsolverDynObstacle1';
            ...
            [output_c, exitflag_c, info_c] = FORCESNLPsolverDynObstacle1Buildable.forcesInitOutputsC(); %#ok<ASGLU>
            ...
            [output, exitflag, info] = FORCESNLPsolverDynObstacle1Buildable.forcesInitOutputsMatlab();
