 ...
 *  - FORCESNLPsolverDynObstacle1
 *  - "include/FORCESNLPsolverDynObstacle1.h"
 *  - FORCESNLPsolverDynObstacle1_adtool2forces
 *  - FORCESNLPsolverDynObstacle1_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(FORCESNLPsolverDynObstacle1, _float)
#define SOLVER_FUN_NAME CONCATENATE(FORCESNLPsolverDynObstacle1, _solve)

#include "include/FORCESNLPsolverDynObstacle1.h"

/* Header of external evaluation function */
solver_int32_default FORCESNLPsolverDynObstacle1_adtool2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FORCESNLPsolverDynObstacle1_interface(void *params, void *outputs, void *info, void *mem, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, mem, fp, &FORCESNLPsolverDynObstacle1_adtool2forces);
}
