...
def get_args():
    ...
    # MPPI Constants
    parser.add_argument('--mppi_k', help='number of sampled MPPI trajectories', type=int, default=500)
    parser.add_argument('--mppi_t', help='time horizon of each MPPI trajectory', type=int, default=10)
